  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50">
        <div className="bg-white relative rounded-lg shadow-xl sm:min-w-[500px] sm:min-h-[500px] overflow-y-auto p-4 sm:p-6">
          {/* Modal Header */}
          <button
            onClick={onClose}
          ...
          <div className="flex p-2 sm:p-6 border-b border-gray-200 text-2xl justify-between items-center mb-4">
